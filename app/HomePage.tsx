...
export default function HomePage({ initialLang, scrollTo }: { initialLang?: 'es' | 'en'; scrollTo?: string } = {}) {
  const [lang, setLang] = useState<'es' | 'en'>(initialLang ?? 'es');
  ...
  // Recordar el idioma elegido para las demás páginas del sitio.
  // Si la ruta fuerza un idioma (p. ej. /en), ese manda sobre lo guardado.
  useEffect(() => {
  ...
  // Rutas de sección (/catalogo, /distribuidores, /contacto): bajar al ancla
  useEffect(() => {
    if (!scrollTo) return;
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            <div className="bg-white grid grid-cols-1 md:grid-cols-2 gap-0 overflow-hidden shadow-2xl rounded-3xl" id="contacto">
              ...
              <div className="p-10 md:p-20 bg-primary flex flex-col justify-center min-h-[350px]">
                ...
                <h2 className="font-headline font-bold text-4xl md:text-5xl text-white mb-6 leading-tight italic">{t.cta.c2Title}</h2>
